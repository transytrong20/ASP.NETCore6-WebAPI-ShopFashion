...
namespace Shop.Webapp.EFcore.Migrations
{
    ...
    [Migration("20240114041250_update_v2")]
            ...
            modelBuilder.Entity("Shop.Webapp.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailCount = 0,
                            AllowLockUser = false,
                            CreatedTime = new DateTime(2024, 1, 14, 11, 12, 50, 35, DateTimeKind.Local).AddTicks(9214),
                            ...
                            Phone = "1",
                            PhoneVerified = false,
                            ResetPasswordExpiry = new DateTime(2024, 1, 14, 4, 12, 50, 35, DateTimeKind.Utc).AddTicks(9204),
            ...
            modelBuilder.Entity("Shop.Webapp.Domain.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Id = new Guid("66cd2269-db59-4521-8c52-16d936500b3c")
                        });
                });
