...
namespace Shop.Webapp.EFcore.Migrations
{
    ...
    [Migration("20231024210401_database")]
            ...
            modelBuilder.Entity("Shop.Webapp.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailCount = 0,
                            AllowLockUser = false,
                            CreatedTime = new DateTime(2023, 10, 25, 4, 4, 1, 176, DateTimeKind.Local).AddTicks(3859),
            ...
            modelBuilder.Entity("Shop.Webapp.Domain.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Id = new Guid("8827a01a-090a-4a2b-a1f8-2f6647ed3f16")
                        });
                });
